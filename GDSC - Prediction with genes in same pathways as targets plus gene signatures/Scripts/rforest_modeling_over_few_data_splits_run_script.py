...
exp = Modeling(name="Pathway genes with signatures - modeling with RForest over few data splits",
...
for drug_id in drugs:
    ...
    with open("../Created data/Results/pathway_genes_with_signatures-rforest_over_few_data_splits.pkl", "wb") as f:
