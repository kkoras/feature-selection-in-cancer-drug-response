...
# SETUP MODELING AND MODELINGRESULTS OBJECTS

enet_seeds = [22, 37, 44, 55, 78]
split_seeds = [11, 37, 52, 71, 98]

exp = Modeling(name="Only targets with expression signatures - modeling with ENet over few data splits",
...
for drug_id in drugs:
    ...
    with open("../Created data/Results/only_targets_with_signatures-enet_over_few_data_splits.pkl", "wb") as f:
