...
exp = Modeling(name="Pathway genes - modeling with ENet over few data splits",
...
for drug_id in drugs:
    ...
    with open("../Created data/Results/pathway_genes-enet_over_few_data_splits.pkl", "wb") as f:
